...
function [fitresults, fitdata] = ...
    fitSinusoidSimple(timestofit, datatofit, varargin)
fitresults = [];
fitdata = [];
...
% options for fit
%myoptions = optimoptions(@lsqnonlin,'Algorithm','levenberg-marquardt'); %,'InitDamping',100);
...
[fit_params, chisq] = lsqnonlin(@sinusoidSimple,params0,lb,ub,myoptions,timestofit,datatofit);
